...
class network_SNN_simpleHead(nn.Module):
    def __init__(self, layerSizes, **kwargs):
        """
        Initialize the SNN (Spiking Neural Network) with arbitrary number of hidden layers. However, the last layer
        is not a spike layer.
